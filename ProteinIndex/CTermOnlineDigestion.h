#ifndef CTERMONLINEDIGESTION_H_
#define CTERMONLINEDIGESTION_H_
...
class CCTermOnlineDigestion : public ProteinIndex::COnlineDigestion
{
public:
	CCTermOnlineDigestion();
	virtual ~CCTermOnlineDigestion();
